  ...
  return (
    <PageContainer>
      <div className="space-y-6">
        <PageHeader
          title="Avisos"
          description="Comunicados de la administración para seguridad"
        />
        ...
        {avisos === undefined ? (
          ...
          <EmptyState
            icon={Megaphone}
            title="Sin avisos"
            description="Los comunicados dirigidos a portería aparecerán aquí."
          />
        ) : (
          <div className="space-y-3">
            {[...avisos]
                ...
                >
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {c.prioridad !== "normal" && (
                      <Badge
                        tone={
                          c.prioridad === "urgente" ? "destructive" : "warning"
                        }
                      >
                    ...
                    {c.audiencia === "guardia" && (
                      <Badge tone="brand">Solo seguridad</Badge>
                    )}
                  </div>
